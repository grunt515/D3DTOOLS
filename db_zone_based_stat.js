...
function check_boss_zone(grinding_zone_param) {
	...
	switch (grinding_zone) {
		...
		case "yellow_zone":
			...
			break;
		case "orange_zone":
			zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_zombie_stat(this.value, 'zonebased', '')'><option value=''>--No Boss--</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option><option value='elf'>Elf</option><option value='pumpkinhead'>Pumpkin Head</option><option value='egghead'>Egg Had</option><option value='santa'>Santa</option><option value='reindeer'>Reindeer</option><option value='slenderman'>Slenderman</option></select>";
			break;
		case "red_zone":
			zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_zombie_stat(this.value, 'zonebased', '')'><option value=''>--No Boss--</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option><option value='elf'>Elf</option><option value='pumpkinhead'>Pumpkin Head</option><option value='egghead'>Egg Had</option><option value='santa'>Santa</option><option value='reindeer'>Reindeer</option><option value='slenderman'>Slenderman</option></select>";
			break;
		case "black_zone":
			...
			break;
		case "white_zone":
			zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_zombie_stat(this.value, 'zonebased', '')'><option value=''>--No Boss--</option><option value='flaminglongarm'>Flaming Long Arm</option><option value='flamingrumbler'>Flaming Rumbler</option><option value='flamingfleshhound'>Flaming Flesh Hound</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option><option value='flamingblacktitan'>Flaming Black Titan</option><option value='elf'>Elf</option><option value='pumpkinhead'>Pumpkin Head</option><option value='egghead'>Egg Had</option><option value='santa'>Santa</option><option value='reindeer'>Reindeer</option><option value='slenderman'>Slenderman</option></select>";
			break;
		case "wasteland":
			zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_zombie_stat(this.value, 'zonebased', '')'><option value=''>--No Boss--</option><option value='devilhound'>Devil Hound</option></select>";
			break;

		default:
			zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_zombie_stat(this.value,'zonebased', '')'><option value=''>--No Boss--</option></select>";
			break;
	}
...
function sum_spawn_zombie(spawn_rate_param, zombie_order_no_param, zombie_hp_param, zombie_exp_param, max_zombie_estimation_param) {
	...
	switch (zombie_order_no_param) {
		case 1:
			new_zombie_spawn_1 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 2:
			new_zombie_spawn_2 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 3:
			new_zombie_spawn_3 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 4:
			new_zombie_spawn_4 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 5:
			new_zombie_spawn_5 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 6:
			new_zombie_spawn_6 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 7:
			new_zombie_spawn_7 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 8:
			new_zombie_spawn_8 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 9:
			new_zombie_spawn_9 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 10:
			new_zombie_spawn_10 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
		...
		case 11:
			new_zombie_spawn_11 = eval(spawn_rate) / 100 * eval(max_zombie_estimation);
